...
![Pull request title as implicit context in Chat](https://github.com/Microsoft/vscode-pull-request-github/raw/HEAD/documentation/changelog/0.124.0/pull-request-implicit-context.png)

- Pull request and issue context can also be manually added to Chat from the "Add Context" menu.

![Explicit Chat context](https://github.com/Microsoft/vscode-pull-request-github/raw/HEAD/documentation/changelog/0.124.0/explicit-chat-context.png)

- Single button for marking Copilot pull requests as ready for review, approved, and automerge (if enabled).

![Single button to mark Copilot pull requests](https://github.com/Microsoft/vscode-pull-request-github/raw/HEAD/documentation/changelog/0.124.0/single-button-copilot-pr.png)
...
* [@vicky1999 (Vignesh)](https://github.com/vicky1999)
  * fix: message wrapping in narrow editor panes [PR [#8121](https://github.com/Microsoft/vscode-pull-request-github/issues/8121)](https://github.com/microsoft/vscode-pull-request-github/pull/8121)
  * feat: Display commit status icon for each commit [PR [#8142](https://github.com/Microsoft/vscode-pull-request-github/issues/8142)](https://github.com/microsoft/vscode-pull-request-github/pull/8142)
  * feat: Add copy comment link button in PR overview [PR [#8150](https://github.com/Microsoft/vscode-pull-request-github/issues/8150)](https://github.com/microsoft/vscode-pull-request-github/pull/8150)
...
![Pull Requests view showing codicon labels and italic draft PR titles](https://github.com/Microsoft/vscode-pull-request-github/raw/HEAD/documentation/changelog/0.122.0/pr-labels.png)

- Emoji completions for `:smile:` style emojis are now available in review comments.

![Emoji completions in review comments](https://github.com/Microsoft/vscode-pull-request-github/raw/HEAD/documentation/changelog/0.122.0/emoji-completions.gif)

- [Markdown alert syntax](https://github.com/orgs/community/discussions/16925) is now rendered in review comments.

![Markdown alerts in review comments](https://github.com/Microsoft/vscode-pull-request-github/raw/HEAD/documentation/changelog/0.122.0/markdown-alerts.png)
...
![Cancel review button](https://github.com/Microsoft/vscode-pull-request-github/raw/HEAD/documentation/changelog/0.122.0/cancel-review.png)
...
* [@bendrucker (Ben Drucker)](https://github.com/bendrucker): Enable all LLM tools in prompts (agent mode) [PR [#6956](https://github.com/Microsoft/vscode-pull-request-github/issues/6956)](https://github.com/microsoft/vscode-pull-request-github/pull/6956)
* [@gerardbalaoro (Gerard Balaoro)](https://github.com/gerardbalaoro): Make branch list timeout configurable (#2840) [PR [#7927](https://github.com/Microsoft/vscode-pull-request-github/issues/7927)](https://github.com/microsoft/vscode-pull-request-github/pull/7927)
* [@wankun-tcj](https://github.com/wankun-tcj): Fix avatar display issue in Pull Request tree view [PR [#7851](https://github.com/Microsoft/vscode-pull-request-github/issues/7851)](https://github.com/microsoft/vscode-pull-request-github/pull/7851)
